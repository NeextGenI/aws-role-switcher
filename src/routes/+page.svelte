...
let buttons:any = []
const farbe:string = ''
let werte:any = {'intern-downloads':'99BCE3',
                 'intern-logging':'99BCE3',
                 'intern-automation':'99BCE3',
                 'intern-share':'B7CA9D',
                 'intern-namespace':'99BCE3',
                 'intern-whoami':'99BCE3',
                 'intern-routing':'99BCE3',
                 'intern-root':'99BCE3',
                 'intern-sec':'99BCE3',
                 'extern-engineering':'FAD791',
                 'extern-customer':'F2B0A9',
                 'extern-playground':'99BCE3',
                 'extern-trial':'FBBF93'
                }
